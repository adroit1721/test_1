      ...
      >
        ...
        <motion.div variants={framerPopItemVariants} className="lg:col-span-5 space-y-6">
          ...
          <div className="h-64 sm:h-72 rounded-3xl overflow-hidden border border-[#cdc6b3]/70 dark:border-[#423e35] shadow-xs relative group bg-[#ebe8e2] dark:bg-[#141311]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3019.1743520511604!2d88.5806837744878!3d24.36854657825363!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39fbef0014219587%3A0x81b451b81c24ba14!2sNew%20Govt.%20Degree%20College%2C%20Rajshahi%20BNCC%20Unit!5e1!3m2!1sen!2sbd!4v1789173315097!5m2!1sen!2sbd"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
