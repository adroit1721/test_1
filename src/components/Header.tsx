...
export const Header: React.FC<HeaderProps> = ({
  ...
  const leftLogo = headerLeftLogoUrl || ASSETS.ngdcLogo || '/assets/ngdc_college_logo.png';
  const rightLogo = headerRightLogoUrl || siteFavicon || ASSETS.bnccLogo;
  const title = headerTitle || 'NGDC-BNCC';
  const subtitle = headerSubtitle || 'New Govt. Degree College, Rajshahi BNCC Platoon';
