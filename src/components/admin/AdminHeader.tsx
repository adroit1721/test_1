...
interface AdminHeaderProps {
  ...
  onSelectTab?: (tab: AdminMenuKey) => void;
...
const TAB_INFO: Record<AdminMenuKey, { label: string; desc: string }> = {
  ...
  branding: { label: 'Header & Branding', desc: 'College crest, BNCC emblem, title & subtitle' },
  ...
  security: { label: 'Security & Credentials', desc: 'Officer ID, master password & brute-force defense' },
  maintenance: { label: 'Site Maintenance & Notices', desc: 'Warning banner, countdown timer & portal lockdown hub' },
};
...
export const AdminHeader: React.FC<AdminHeaderProps> = ({
  ...
  const { officerId, logoutAdmin } = useAdminData();
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="text-left hidden lg:block leading-tight">
              ...
              <span className="text-[10px] text-[#7c7767] dark:text-[#aca596] font-mono">ID: {officerId}</span>
            </div>
          </button>
            ...
            <div className="absolute right-0 mt-2 w-64 bg-[#fcf9f3] dark:bg-[#1e1d19] border border-[#cdc6b3] dark:border-[#423e35] rounded-2xl p-4 shadow-xl z-50 space-y-3 animate-fadeIn">
              <div className="border-b border-[#cdc6b3]/50 dark:border-[#423e35] pb-3">
                ...
                <div className="mt-1.5 flex items-center justify-between text-[11px] bg-[#f6f3ed] dark:bg-[#141311] px-2.5 py-1 rounded-lg border border-[#cdc6b3]/40 dark:border-[#333]">
                  <span className="text-[#7c7767] dark:text-[#aca596]">Officer ID:</span>
                  <span className="font-mono font-bold text-[#6b5e10] dark:text-[#eedc82]">{officerId}</span>
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                >
                  <ShieldCheck className="w-4 h-4 text-[#6b5e10] dark:text-[#eedc82]" />
