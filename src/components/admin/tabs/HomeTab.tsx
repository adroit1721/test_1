                ...
                <form onSubmit={handleSaveSlide} className="space-y-4 text-xs">
                  ...
                  <div>
                    <CloudinaryUploader
                      ...
                      label="Slide Photo (Original Quality - Direct Cloudinary Upload)"
                      helperText="Uploads the original photo directly to Cloudinary without compression to preserve high resolution."
                      aspectRatio="banner"
                      folder="home-slider"
