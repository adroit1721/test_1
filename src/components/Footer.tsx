  ...
  const activeSocialLinks: FooterSocialLink[] =
    footerConfig.socialLinks && footerConfig.socialLinks.length > 0
      ...
      : [
          ...
          { id: 'soc-yt', platform: 'youtube', label: 'YouTube', url: footerConfig.youtubeUrl || 'https://youtube.com' },
          { id: 'soc-ig', platform: 'instagram', label: 'Instagram', url: footerConfig.instagramUrl || 'https://instagram.com' },
          ...(footerConfig.linkedinUrl ? [{ id: 'soc-li', platform: 'linkedin', label: 'LinkedIn', url: footerConfig.linkedinUrl }] : []),
        ];
