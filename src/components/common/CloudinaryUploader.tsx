...
import { compressAndConvertToDataUrl, uploadImageToCloudinary } from '../../utils/cloudinary';
...
export const CloudinaryUploader: React.FC<CloudinaryUploaderProps> = ({
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      const imageUrl = await uploadImageToCloudinary(file, folder, skipCompression);
