...
export const ASSETS = {
  ...
  heroMain: 'https://res.cloudinary.com/hqmx8juj/image/upload/v1788926069/ngdc_bncc/vnvdhegdyyymh6zbvfkg.jpg',
};
...
export const HERO_SLIDES_DATA: HeroSlide[] = [
  {
    ...
    imageUrl: 'https://res.cloudinary.com/hqmx8juj/image/upload/v1788926069/ngdc_bncc/vnvdhegdyyymh6zbvfkg.jpg',
    ctaText: 'Join Us',
    ctaLink: '#recruitment',
  },
];
